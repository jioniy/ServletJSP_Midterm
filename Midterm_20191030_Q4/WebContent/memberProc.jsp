...
%>
<jsp:useBean id="regBean" class="jwlee_20191030_4.MemberBean"/>
  ...
  <tr> 
	...
	<table width="90%" border="1" cellspacing="0" cellpadding="2"  align="center">
        <form name="regForm" method="post" action="memberInsert.jsp">
          ...
          <tr> 
            <td>성별</td>
            <td> <jsp:getProperty name="regBean" property="gender" /></td>
          </tr>
          <tr> 
            <td>생년월일</td>
          ...
          <tr> 
            <td>전공</td>
            <td> <jsp:getProperty name="regBean" property="major" /></td>
          </tr>
          <tr> 
